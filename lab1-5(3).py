...
win.setWindowTitle('acceleration/velocity')
win.resize(1600, 900)
win2 = pg.GraphicsLayoutWidget()
win2.setWindowTitle('displacement')
...
def plotData():
    ...
    if (len(signal) == 6):
        ...
        curve7.setData(d[0], pen=pg.mkPen('g', width=3))
        curve8.setData(d[1], pen=pg.mkPen('r', width=3))
        curve9.setData(d[2], pen=pg.mkPen('b', width=3))
...
curve6 = fig6.plot()
fig7 = win2.addPlot()
fig7.showGrid(x=True, y=True)
fig7.setRange(xRange=[0, xLength], yRange=[ymin, ymax], padding=0)
fig7.setLabel(axis='left', text='g')
fig7.setLabel(axis='bottom', text='x/point')
fig7.setTitle('displacement x')
curve7 = fig7.plot()
fig8 = win2.addPlot()
fig8.showGrid(x=True, y=True)
fig8.setRange(xRange=[0, xLength], yRange=[ymin, ymax], padding=0)
fig8.setLabel(axis='left', text='g')
fig8.setLabel(axis='bottom', text='x/point')
fig8.setTitle('displacement y')
curve8 = fig8.plot()
fig9 = win2.addPlot()
fig9.showGrid(x=True, y=True)
fig9.setRange(xRange=[0, xLength], yRange=[ymin, ymax], padding=0)
fig9.setLabel(axis='left', text='g')
fig9.setLabel(axis='bottom', text='x/point')
fig9.setTitle('displacement z')
curve9 = fig9.plot()
...
d = [np.zeros(xLength).__array__('d'), np.zeros(xLength).__array__('d'), np.zeros(xLength).__array__('d')]
